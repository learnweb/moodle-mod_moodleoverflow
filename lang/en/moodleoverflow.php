...
$string['moodleoverflow:notanonymous'] = 'Marks users that post non anonymous posts if only students should be anonymous in the moodleoverflow.';
...
$string['anonymous:students'] = 'Only students; Teachers posts are not anonymous. (Irreversible!)';
...
$string['desc:students_anonymous'] = 'Students names will not be displayed in their questions and comments';
