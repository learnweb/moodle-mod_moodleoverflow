...
Feature: A teacher can set one of 3 possible options for tracking read moodleoverflow posts
  ...
  Background:
    Given the following "users" exist:
      | username | firstname | lastname | email | trackmoodleoverflows |
  ...
  Scenario: Tracking moodleoverflow posts optional with user tracking on
    Given I add a "Moodleoverflow" to section "1" and I fill the form with:
      | Moodleoverflow name | Test moodleoverflow name |
      | Description | Test moodleoverflow description |
  ...
  Scenario: Tracking moodleoverflow posts optional with user tracking off
    Given I add a "Moodleoverflow" to section "1" and I fill the form with:
      | Moodleoverflow name | Test moodleoverflow name |
      | Description | Test moodleoverflow description |
      | Read tracking | Optional |
  ...
  Scenario: Tracking moodleoverflow posts forced with user tracking on
  ...
  Scenario: Tracking moodleoverflow posts forced with user tracking off
    Given the following config values are set as admin:
      | fmoodleoverflow_allowforcedreadtracking | 1 |
    And I am on site homepage
    And I follow "Course 1"
    Given I add a "Moodleoverflow" to section "1" and I fill the form with:
      | Moodleoverflow name | Test moodleoverflow name |
  ...
  Scenario: Tracking moodleoverflow posts forced (with force disabled) with user tracking on
    Given the following config values are set as admin:
      | moodleoverflow_allowforcedreadtracking | 1 |
    And I am on site homepage
    And I follow "Course 1"
  ...
  Scenario: Tracking moodleoverflow posts forced (with force disabled) with user tracking off
    Given the following config values are set as admin:
      | moodleoverflow_allowforcedreadtracking | 1 |
    And I am on site homepage
    And I follow "Course 1"
