...
/**
 * Class manager for moodleoverflow activity
 *
...
class manager {
    /** Module name. */
    public const MODULE = 'moodleoverflow';
    ...
    /**
     * Count unread posts for the current user.
     *
     * @return int number of unread posts
     */
    public function count_unread_posts_for_user(): int {
        return count(moodleoverflow_get_discussions_unread($this->cm));
    }
}
